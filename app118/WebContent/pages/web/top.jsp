...
<div class="inner">
	<div class="top-logo">
		<a href="index.jsp" title="${system.webName}" id="web_logo"><img src="images/logo.png" alt="${system.webName}" title="${system.webName}" style="margin:20px 0px 0px 0px;" /></a>
	...
	<nav>
		<ul class="list-none">
			<li id="nav_10001" style='width:121px;'>
				<a href='index.jsp' class='nav'><span>网站首页</span></a>
			</li>
			
			<li class="line"></li>
			<li id='nav_1' style='width:121px;' >
				<a href='about.jsp' class='hover-none nav'><span>关于我们</span></a>
			</li>
			
			<li class="line"></li>
			<li id='nav_2' style='width:121px;' >
				<a href='news.jsp'  class='hover-none nav'><span>新闻资讯</span></a>
			</li>
			
			<li class="line"></li>
			<li id='nav_3' style='width:121px;' >
				<a href='index.jsp' class='hover-none nav'><span>产品展示</span></a>
			</li>
			
			<li class="line"></li>
			<li id='nav_32' style='width:121px;' >
				<a href='index.jsp'   class='hover-none nav'><span>下载中心</span></a>
			</li>
			
			<li class="line"></li>
			<li id='nav_33' style='width:121px;' >
				<a href='index.jsp'   class='hover-none nav'><span>客户案例</span></a>
			</li>
			
			<li class="line"></li>
			<li id='nav_36' style='width:120px;' >
				<a href='index.jsp'   class='hover-none nav'><span>招贤纳士</span></a>
			</li>
			
			<li class="line"></li>
			<li id='nav_22' style='width:120px;' >
				<a href='index.jsp'  class='hover-none nav'><span>联系我们</span></a>
			</li>
		</ul>
	</nav>
	<!-- 顶部菜单结束 -->
