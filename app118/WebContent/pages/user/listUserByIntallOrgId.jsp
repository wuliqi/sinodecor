...
<body>
	...
	<div id="toptoolbar" class="l-toolbar" ligeruiid="toptoolbar" style="width:99%;">
		<div class="l-toolbar-item l-panel-btn" toolbarid="item-3"
			jQuery1405912963467="24" onclick="toBindUserAndAirDevie();">
			<SPAN>&nbsp;代装app用户绑定</SPAN>
...
<script type="text/javascript">
	var dialog=null;//弹出对话框
     var url = "/app118/userAction/listUserByIntallOrgId";
     $(function (){
     ...
     function forClean(){
   	 ...
   	 //加盟店绑定分销售用户及控制器
   	 function toBindUserAndAirDevie(){
   		var url ="/app118/userAction/toBindUserAndAirDevie";
  		...
  		window['g']= $("#maingrid").ligerGrid({
            	  ...
            	  height:'99%',
  	              ...
  	              columns: [
	  	              ...
	  	              { display: '安装门店', name: 'installOrgName', width: '10%' },
	  	              ...
	  	              { display: '绑定时间', name: 'createTime', width: '14%',type: "date", format:"yyyy-mm-dd HH:mm:ss"},
