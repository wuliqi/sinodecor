	...
	<table border="0">
		<tr>
			...
			<td class="tdtext" nowrap="nowrap">
				<input type="hidden" name="orgId" id="orgId" value="${u.orgId}">
				<input type="text" name="loginName" id="loginName" value="${u.loginName}" style="width: 220px;" readonly="readonly"/><font color="red">*</font>手机号，即登录app的用户账号
			</td>
		</tr>
		<tr>
			<td  class="tdtitle">真实姓名：</td>
			<td class="tdtext" nowrap="nowrap">
				<input type="text" name="realName" id="realName"   value="${u.realName}"  style="width: 220px;" readonly="readonly"/><font color="red">*</font>
			</td>
		</tr>
		<tr>
			<td  class="tdtitle">姓别：</td>
			<td  nowrap="nowrap" class="tdtext">
				<select id="sex" name="sex" style="width: 220px;height: 20px;" disabled="disabled">
					<option value="">---请选择---</option>
					<option value="男" <c:if test="${u.sex=='男'}">selected </c:if>>男</option>
					<option value="女" <c:if test="${u.sex=='女'}">selected </c:if>>女</option>
				</select>
				<font color="red">*</font>
			</td>
		</tr>
		<tr>
			<td  class="tdtitle">安装门店：</td>
			<td  nowrap="nowrap" class="tdtext">
				<select name="installOrgId" id="installOrgId" style="width: 220px;height: 20px;" ${disabled}>
					<option value="">---请选择---</option>
...
<script language="javascript">
	$(function() {
		...
		$("#submitBtn").click(function() {
			...
			var installOrgId=$("#installOrgId").val();
			...
			if(installOrgId==null||trim(installOrgId)==''){
				$.ligerDialog.warn("安装门店不能为空，请选择。");
				$("#installOrgId").focus();
				return;
			}
			...
			$("#installOrgId").removeAttr("disabled"); 
