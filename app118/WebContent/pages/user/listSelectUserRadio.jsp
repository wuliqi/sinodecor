	...
	var dialog=null;//弹出对话框
     ...
     function forClean(){
   	 ...
   	 function forSearch(){
     	...
     	var orgId=$("#orgId").val();
   	    var params="?loginName="+loginName+"&realName="+encodeURI(realName)+"&fromCreateTime="+
   	    		fromCreateTime+"&toCreateTime="+toCreateTime+"&orgId="+orgId;
   	    init(url+params); 
   	 }
	 ...
	 function select(){
			...
			if(rowid.length==0){
				 ...
				 if(len>1){
					 ...
					 realName=rowid[0].realName;
				 }
			}
			parent.closeDialogSelect(userId,realName);
		}
  		...
  		window['g']= $("#maingrid").ligerGrid({
            	  ...
            	  height:'99%',
  	              ...
  	              columns: [
	  	              ...
	  	              { display: '所属组织机构', name: 'orgName', width: '25%' },
