	...
	<table border="0">
		<tr>
			...
			<td class="tdtext" nowrap="nowrap">
				<input type="text" name="roleName" id="roleName"  style="width: 220px;"/><font color="red">*</font>
			</td>
		</tr>
		<tr>
			<td  class="tdtitle">角色编码：</td>
			<td class="tdtext" nowrap="nowrap">
				<input type="text" name="roleCode" id="roleCode"  style="width: 220px;"/><font color="red">*</font>
			</td>
		</tr>
		<tr>
		...
		<tr style="display: none">
			...
			<td class="tdtext" nowrap="nowrap">
				<input type="text" name="sort" id="sort" value="10000"  style="width: 220px;"/><font color="red">*</font>
			</td>
		</tr>
		<tr>
			<td class="tdtitle">分配权限：</td>
			<td  nowrap="nowrap">
				<textarea rows="15" cols="26" name="menuName" id="menuName"></textarea>
				<font color="red">*</font>
		...
		<tr>
			...
			<td  nowrap="nowrap">
				<textarea rows="5" cols="26" name="roleDesc" id="roleDesc"></textarea>
			</td>
		</tr>
		<tr >
			<td colspan="2" > 
...
<script language="javascript">
	...
	$(function() {
		...
		var url = "/app118/roleAction/addRole";
	...
	function f_selectMenu(item,dialog){
        ...
        //alert('选择的菜单名称：' + menuNames);
        //alert('选择的菜单id：' + menuIds);
        dialog.hide();
	}
</script>
</html>